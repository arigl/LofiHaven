...
export function Model(props) {
  const { nodes, materials } = useGLTF("/Chill-transformed.glb");
  const { size } = useThree();
  ...
  return (
    <group {...props} dispose={null}>
      ...
      />
      <mesh
        geometry={nodes.Estelle_Desk_Swivel_Chair.geometry}
        material={materials["Tecido cinza.001"]}
        position={[0.55, 0, 1.06]}
      ...
      <mesh
        geometry={nodes.HIGH.geometry}
        material={materials["Default OBJ.004"]}
        position={[5.176, 0, -2.927]}
        scale={1.546}
      />
      <instancedMesh
        args={[nodes.Mesh_2.geometry, materials.PaletteMaterial001, 8]}
        instanceMatrix={nodes.Mesh_2.instanceMatrix}
      />
      <instancedMesh
        args={[nodes.Star.geometry, materials.PaletteMaterial004, 5]}
        instanceMatrix={nodes.Star.instanceMatrix}
      />
      <instancedMesh
        args={[nodes.Star_1.geometry, materials.PaletteMaterial005, 5]}
        instanceMatrix={nodes.Star_1.instanceMatrix}
      />
    </group>
  );
}

useGLTF.preload("/Chill-transformed.glb");
